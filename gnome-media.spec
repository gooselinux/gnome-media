...
# https://bugzilla.redhat.com/show_bug.cgi?id=595519
Patch1: gnome-media-2.29.91-fix-omf-category.patch

# translation updates
# https://bugzilla.redhat.com/show_bug.cgi?id=589205
Patch2: gnome-media-translations.patch

# https://bugzilla.gnome.org/show_bug.cgi?id=620360
Patch3: 0001-Force-updating-the-custom-theme-dir-on-change.patch

# https://bugzilla.gnome.org/show_bug.cgi?id=620365
Patch4: 0001-Fix-alert-preview-requiring-a-double-click.patch
...
%package libs
Summary: Libraries for gnome-media
Group: Development/Libraries
...
%patch1 -p1 -b .fix-omf-category
%patch2 -p1 -b .translations
%patch3 -p1 -b .old-alert
%patch4 -p1 -b .preview
...
%defattr(-, root, root)
%config %{_sysconfdir}/gconf/schemas/gnome-audio-profiles.schemas
%{_libdir}/*.so.*
...
%changelog
* Wed Jun 02 2010 Bastien Nocera <bnocera@redhat.com> 2.29.91-6
- Fix alert sound requiring a double-click to preview
Resolves: rhbz#591909

* Wed Jun 02 2010 Bastien Nocera <bnocera@redhat.com> 2.29.91-5
- Fix old alert sound being used in some cases
Related: rhbz#591902

* Thu May 27 2010 Matthias Clasen <mclasen@redhat.com> 2.29.91-4
- Make documentation show up in yelp
Resolves: #595519

* Mon May 17 2010 Matthias Clasen <mclasen@redhat.com> 2.29.91-3
- Updated translations
Resolves: #589205

* Wed May  5 2010 Matthias Clasen <mclasen@redhat.com> 2.29.91-2
- Fix a space-saving hack that is causing multilib conflicts
Resolves: #586207

* Mon Mar 22 2010 Bastien Nocera <bnocera@redhat.com> 2.29.91-1
- Update to 2.29.91
Related: rhbz#573009

* Sun Oct 18 2009 Matthias Clasen <mclasen@redhat.com> 2.28.1-2
...
* Thu May 20 2005 John (J5) Palmieri <johnp@redhat.com> 2.10.2-4
...
* Tue Jan  1 2005 Matthias Clasen <mclasen@redhat.com> 2.9.90-1
- Update to 2.9.90
...
* Wed Aug 31 2004 Colin Walters <walters@redhat.com> 2.7.92-2
- Add patch to use correct sink for gnome-cd

* Wed Aug 31 2004 Colin Walters <walters@redhat.com> 2.7.92-1
- Update to 2.7.92
